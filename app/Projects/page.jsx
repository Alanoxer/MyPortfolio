...
export default function Projects() {
  return ( <>
    <h1 className=" relative font-mono leading-10 tracking-tight 
     sm:leading-none md:text-5xl text-3xl lg:text-6xl mb-10
     mt-2 bg-clip-text text-transparent bg-gradient-to-r from-slate-700 via-slate-600 to-slate-500 md:inline-block border-b-2 border-r-2 pb-3 pr-3">
          Projects
    </h1>

    <div className=" relative  ml-20 md:text-3xl text-3xl lg:text-3xl 2xl: font-semibold
     flex flex-row ">
      <span className=" mt-3">
        A News Page made with :
      </span>
    ...
    <g>
      ...
      <li>
    <svg className=' w-16 h-16 ' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><title>Tailwind</title><path d="M9,13.7q1.4-5.6,7-5.6c5.6,0,6.3,4.2,9.1,4.9q2.8.7,4.9-2.1-1.4,5.6-7,5.6c-5.6,0-6.3-4.2-9.1-4.9Q11.1,10.9,9,13.7ZM2,22.1q1.4-5.6,7-5.6c5.6,0,6.3,4.2,9.1,4.9q2.8.7,4.9-2.1-1.4,5.6-7,5.6c-5.6,0-6.3-4.2-9.1-4.9Q4.1,19.3,2,22.1Z" style={{fill:"#44a8b3"}}/></svg>
      </li>

      </ul>
      </div>

    <div class=" relative max-w-5xl mx-auto h-36 mt-72">

	    <div id="default-carousel" class="relative h-32" data-carousel="static">
        
      <div class=" relative h-20 rounded-lg sm:h-40 xl:h-64 2xl:h-40">
            
      <div class=" duration-700 ease-in-out" data-carousel-item>
      <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-gray-800">First Slide</span>
      <Image width={900} height={900}src="/kenkakef.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
      </div>
